...
public class UserControllerTest {
  ...
  public void register_success() throws Exception {
    ...
    RequestBuilder requestBuilder = post(userRegisterRequest, "register");
  ...
  public void login_success() throws Exception {
    ...
    requestBuilder = post(userLoginRequest, "login");
  ...
  public void login_invalidEmailFormat() throws Exception {
    ...
    RequestBuilder requestBuilder = post(userLoginRequest, "login");
  ...
  private RequestBuilder post(Object request, String str) throws Exception {
    String json = objectMapper.writeValueAsString(request);

    return MockMvcRequestBuilders.post("/users/{str}", str)
